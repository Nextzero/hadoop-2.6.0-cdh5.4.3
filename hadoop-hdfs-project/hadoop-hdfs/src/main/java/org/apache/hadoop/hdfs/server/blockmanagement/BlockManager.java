...
public class BlockManager {
  ...
  //czhc: Daemon继承自Thread,内部调用setDaemon(true);
  ...
  public void metaSave(PrintWriter out) {
    ...
    datanodeManager.fetchDatanodes(live, dead, false);  //czhc: 通过DatanodeManager来获取当前活动的节点与死亡的节点
  ...
  int computeDatanodeWork() {
    ...
    final int numlive = heartbeatManager.getLiveDatanodeCount();    //czhc: 心跳管理，获取上线的DN节点数量
