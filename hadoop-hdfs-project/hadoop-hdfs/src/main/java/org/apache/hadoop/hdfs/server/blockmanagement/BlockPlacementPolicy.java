...
public abstract class BlockPlacementPolicy {
   ...
   * @param writer the writer's machine, null if not in the cluster.  //czhc: 客户端所在节点
   * @param chosen datanodes that have been chosen as targets.  //czhc: 据说这个列表的节点，表示已拥有该副本
   * @param returnChosenNodes decide if the chosenNodes are returned. //czhc:和chosen参数对应
  ...
  public abstract DatanodeStorageInfo[] chooseTarget(String srcPath,
                                             ...
                                             long blocksize,
                                             BlockStoragePolicy storagePolicy); //czhc: BlockStoragePolicy ?? 什么
   ...
   * czhc:
   * 判断指定块的副本是否符合存储策略，若不符合则返回一个删除的候选副本
   *
  ...
  abstract protected void initialize(Configuration conf,  FSClusterStats stats, 
                                     ...
                                     Host2NodesMap host2datanodeMap); //czhc: 初始化策略接口
